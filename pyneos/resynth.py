...
def resynthesize(in_file, out_file, synlib = mypaths.xorlib):
    ...
    os.system("{0} < abc_script_gennet ".format(mypaths.abc))
...
if __name__ == "__main__":
    ...
    if sys.argv[3] == 'simp':
        resynthesize(sys.argv[1], sys.argv[2], mypaths.abclib)
    elif sys.argv[3] == 'and':
        resynthesize(sys.argv[1], sys.argv[2], mypaths.xorlib)
